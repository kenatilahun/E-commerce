...
import EcommerceHeroMockup from "../mockups/ecommerce-hero/EcommerceHero.jsx";
  ...
  useEffect(() => {
    ...
    async function loadComponent() {
      ...
      try {
        ...
        if (!comp) {
          setError(
            `No exported React component found in ${componentPath}.jsx\n\nMake sure the file has at least one exported function component.`,
          );
          return;
        }
        setComponent(() => comp);
...
const EcommerceHero = () => {
  ...
  if (previewPath) {
    return (
      <PreviewRenderer componentPath={previewPath} modules={modules} />
    );
  }

  return <EcommerceHeroMockup />;
};
